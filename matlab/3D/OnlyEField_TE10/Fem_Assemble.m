...
for elIdx = 1:elNumGlo % goes throug the amount of thetras
    ...
    [KElMtx_EE] = ...
        Fem_CmpElMtx(xyz, ma2er{el2ma(elIdx)}, ma2si{el2ma(elIdx)},k0);
    %for edges
...
for elIdx = 1: (edIdx_port1, edIdx_port2)% goes throug the amount of thetras
    
end
    

KNtx = sparse(irRes_EE, icRes_EE, meRes_EE, edNumGlo, edNumGlo);
