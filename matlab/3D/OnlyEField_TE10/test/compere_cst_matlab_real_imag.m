...
for f = f_list(10:end)
    ...
    CST_ExRe = griddata(CST_data(:,1),CST_data(:,2),CST_data(:,3),real(CST_data(:,4)+CST_data(:,4+3)*1i),Xq,Yq,Zq);
    CST_ExIm = griddata(CST_data(:,1),CST_data(:,2),CST_data(:,3),imag(CST_data(:,4)+CST_data(:,4+3)*1i),Xq,Yq,Zq);
    
    CST_EyRe = griddata(CST_data(:,1),CST_data(:,2),CST_data(:,3),real(CST_data(:,5)+CST_data(:,5+3)*1i),Xq,Yq,Zq);
    CST_EyIm = griddata(CST_data(:,1),CST_data(:,2),CST_data(:,3),imag(CST_data(:,5)+CST_data(:,5+3)*1i),Xq,Yq,Zq);
    
    CST_EzRe = griddata(CST_data(:,1),CST_data(:,2),CST_data(:,3),real(CST_data(:,6)+CST_data(:,6+3)*1i),Xq,Yq,Zq);
    CST_EzIm = griddata(CST_data(:,1),CST_data(:,2),CST_data(:,3),imag(CST_data(:,6)+CST_data(:,6+3)*1i),Xq,Yq,Zq);
    ...
    matlab_ExRe = griddata(matlab_data.no2xyz(1,:),matlab_data.no2xyz(2,:),matlab_data.no2xyz(3,:),real(exFld_all*(-1i)),Xq,Yq,Zq);
    matlab_ExIm = griddata(matlab_data.no2xyz(1,:),matlab_data.no2xyz(2,:),matlab_data.no2xyz(3,:),imag(exFld_all*(-1i)),Xq,Yq,Zq);
    
    matlab_EyRe = griddata(matlab_data.no2xyz(1,:),matlab_data.no2xyz(2,:),matlab_data.no2xyz(3,:),real(eyFld_all*(-1i)),Xq,Yq,Zq);
    matlab_EyIm = griddata(matlab_data.no2xyz(1,:),matlab_data.no2xyz(2,:),matlab_data.no2xyz(3,:),imag(eyFld_all*(-1i)),Xq,Yq,Zq);
    
    matlab_EzRe = griddata(matlab_data.no2xyz(1,:),matlab_data.no2xyz(2,:),matlab_data.no2xyz(3,:),real(ezFld_all*(-1i)),Xq,Yq,Zq);
    matlab_EzIm = griddata(matlab_data.no2xyz(1,:),matlab_data.no2xyz(2,:),matlab_data.no2xyz(3,:),imag(ezFld_all*(-1i)),Xq,Yq,Zq);
